...
game-server: utils.c game-server.c
	gcc -g -lncurses -lczmq -lzmq utils.c game-server.c -o $@

astronaut-client: utils.c astronaut-client.c
	gcc -g -lncurses -lzmq -lczmq utils.c astronaut-client.c -o $@

outer-space-display: utils.c outer-space-display.c
	gcc -g -lncurses -lzmq -lczmq utils.c outer-space-display.c -o $@
